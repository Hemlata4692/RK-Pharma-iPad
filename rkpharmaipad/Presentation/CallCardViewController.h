...

{
    ...
    NSMutableArray *callcard_array,*location_array,*clinic_array;
    ...
    IBOutlet UIButton *clinic_button,*location_button,*backbutton,*search,*issuedby_company;
...
@property(nonatomic,retain)UIButton *clinic_button,*location_button,*backbutton,*search,*issuedby_company;
